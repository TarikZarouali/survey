(()=>{
    var e, o = {
        984: (e,o,i)=>{
            ...
            ["input", "select", "textarea", "a[href]", "button", "[tabindex]", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])'])
              , t = r.join(",")
              , s = "undefined" == typeof Element ? function() {}
            : Element.prototype.matches || Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector;
            function m(e, o) {
                o = o || {};
                var i, n, a, r = [], m = [], d = e.querySelectorAll(t);
                for (o.includeContainer && s.call(e, t) && (d = Array.prototype.slice.apply(d)).unshift(e),
                i = 0; i < d.length; i++)
                    c(n = d[i]) && (0 === (a = u(n)) ? r.push(n) : m.push({
                        documentOrder: i,
                        tabIndex: a,
                        node: n
                    }));
            ...
            k.prototype = {
                ...
                emit: function(e) {
                    for (var o = [].slice.call(arguments, 1), i = ((this.e || (this.e = {}))[e] || []).slice(), n = 0, a = i.length; n < a; n++)
                        i[n].fn.apply(i[n].ctx, o);
                    return this
                },
                off: function(e, o) {
                    var i = this.e || (this.e = {})
                    ...
                    if (n && o)
                        for (var r = 0, t = n.length; r < t; r++)
                            n[r].fn !== o && n[r].fn._ !== o && a.push(n[r]);
            ...
            function T(e, o, i) {
                ...
                I(o) ? ((m = E(o)).x += o.clientLeft,
                m.y += o.clientTop) : r && (m.x = M(r))),
                {
            ...
            function oe(e) {
                var o, i = e.reference, n = e.element, a = e.placement, r = a ? X(a) : null, t = a ? Q(a) : null, s = i.x + i.width / 2 - n.width / 2, m = i.y + i.height / 2 - n.height / 2;
                switch (r) {
                case R:
                    o = {
                        x: s,
            ...
            function ne(e) {
                var o, i = e.popper, n = e.popperRect, a = e.placement, r = e.offsets, t = e.position, s = e.gpuAcceleration, m = e.adaptive, c = function(e) {
                    var o = e.x
                      , i = e.y
                ...
                if (m) {
                    ...
                    h === C(i) && (h = z(i)),
                    a === R && (f = V,
                    g -= h.clientHeight - n.height,
                    g *= s ? 1 : -1),
                    a === W && (v = H,
                    d -= h.clientWidth - n.width,
                    d *= s ? 1 : -1)
                }
                var j, p = Object.assign({
                    position: t
                }, m && ie);
                return s ? Object.assign({}, p, ((j = {})[f] = l ? "0" : "",
                j[v] = u ? "0" : "",
                j.transform = (y.devicePixelRatio || 1) < 2 ? "translate(" + d + "px, " + g + "px)" : "translate3d(" + d + "px, " + g + "px, 0)",
                j)) : Object.assign({}, p, ((o = {})[f] = l ? g + "px" : "",
                o[v] = u ? d + "px" : "",
                o.transform = "",
                o))
            }
            ...
            function ge(e, o) {
                return "viewport" === o ? de(function(e) {
                    var o = C(e)
                      ...
                      , n = o.innerWidth
                      , a = o.innerHeight;
                    return i && /iPhone|iPod|iPad/.test(navigator.platform) && (n = i.width,
                    a = i.height),
                    {
                        width: n,
                        height: a,
                    ...
                    var o = C(e)
                      , i = S(e)
                      , n = T(z(e), o);
                    return n.height = Math.max(n.height, o.innerHeight),
                    n.width = Math.max(n.width, o.innerWidth),
                    n.x = -i.scrollLeft,
                    n.y = -i.scrollTop,
                    n
                }(z(e)))
            ...
            function ue(e, o, i) {
                var n = "clippingParents" === o ? function(e) {
                  ...
                  , t = a.reduce((function(o, i) {
                    ...
                    return o.top = Math.max(n.top + a.top, o.top),
                    o.right = Math.min(n.right - a.right, o.right),
                    o.bottom = Math.min(n.bottom - a.bottom, o.bottom),
                    o.left = Math.max(n.left + a.left, o.left),
                    o
                }
                ), ge(e, r));
            ...
            var pe = function(e) {
                ...
                defaultModifiers: [{
                    ...
                    fn: function(e) {
                        ...
                        Object.keys(o.elements).forEach((function(e) {
                            var i = o.styles[e] || {}
                              , n = o.attributes[e] || {}
                              , a = o.elements[e];
                            I(a) && A(a) && (Object.assign(a.style, i),
                    ...
                    effect: function(e) {
                        ...
                        return Object.assign(o.elements.popper.style, i.popper),
                        ...
                        function() {
                            Object.keys(o.elements).forEach((function(e) {
                                ...
                                I(n) && A(n) && (Object.assign(n.style, r),
                        ...
                        if (!o.modifiersData[n]._skip) {
                            ...
                            if (x)
                                for (var _ = function(e) {
                                    ...
                                    ;
                            o.placement !== E && (o.modifiersData[n]._skip = !0,
                            o.placement = E,
                            o.reset = !0)
                        }
                    },
                    ...
                    phase: "main",
                    fn: function(e) {
                        var o, i = e.state, n = e.name, a = i.elements.arrow, r = i.modifiersData.popperOffsets, t = X(i.placement), s = ee(t), m = [W, H].indexOf(t) >= 0 ? "height" : "width";
                        if (a && r) {
                    ...
                    effect: function(e) {
                        var o = e.state
                          ...
                          , t = i.padding
                          , s = void 0 === t ? 0 : t;
                        null != r && ("string" != typeof r || (r = o.elements.popper.querySelector(r))) && ce(o.elements.popper, r) && (o.elements.arrow = r,
              ...
              , ke = function() {
                var e = {
                    ...
                    parse: function(o, i) {
                        ...
                        ("string" == typeof o ? u : g)(o, {
                            ...
                            ext: i.ext || e.ext,
                            size: i.folder || (n = i.size || e.size,
                            "number" == typeof n ? n + "x" + n : n),
                ...
                function g(e, o) {
                    for (var n, a, r, s, c, g, u, l, v, f, y, h, j, p = function e(o, i) {
                        for (var n, a, r = o.childNodes, s = r.length; s--; )
                            3 === (a = (n = r[s]).nodeType) ? i.push(n) : 1 !== a || "ownerSVGElement"in n || t.test(n.nodeName.toLowerCase()) || e(n, i);
                        return i
                    }(e, []), b = p.length; b--; ) {
                        for (r = !1,
                        ...
                        g = (c = p[b]).nodeValue,
                        l = 0; u = i.exec(g); ) {
                            if ((v = u.index) !== l && s.appendChild(m(g.slice(l, v), !0)),
                            h = d(y = u[0]),
                            l = v + y.length,
                            j = o.callback(h, o),
                            h && j) {
                                for (a in (f = new Image).onerror = o.onerror,
                                f.setAttribute("draggable", "false"),
                                n = o.attributes(y, h))
                                    n.hasOwnProperty(a) && 0 !== a.indexOf("on") && !f.hasAttribute(a) && f.setAttribute(a, n[a]);
                            ...
                            f || s.appendChild(m(y, !1)),
                            f = null
                        }
                        r && (l < g.length && s.appendChild(m(g.slice(l), !0)),
                ...
                function u(e, o) {
                    return f(e, (function(e) {
                        ...
                        if (t && s) {
                            for (n in a = "<img ".concat('class="', o.className, '" ', 'draggable="false" ', 'alt="', e, '"', ' src="', s, '"'),
                            i = o.attributes(e, t))
                                i.hasOwnProperty(n) && 0 !== n.indexOf("on") && -1 === a.indexOf(" " + n + "=") && (a = a.concat(" ", n, '="', i[n].replace(r, l), '"'));
                            a = a.concat("/>")
                        }
                        return a
                    }
                ...
                function y(e, o) {
                    for (var i = [], n = 0, a = 0, r = 0; r < e.length; )
                        n = e.charCodeAt(r++),
                        a ? (i.push((65536 + (a - 55296 << 10) + (n - 56320)).toString(16)),
                        a = 0) : 55296 <= n && n <= 56319 ? a = n : i.push(n.toString(16));
                    return i.join(o || "-")
                }
            }();
            ...
            class Ae {
                ...
                render() {
                    ...
                    return this.emoji = Ce("div", "emoji-picker__preview-emoji"),
                    e.appendChild(this.emoji),
                    this.name = Ce("div", "emoji-picker__preview-name"),
                ...
                showPreview(e) {
                    let o = e.emoji;
                    e.custom ? o = `<img class="emoji-picker__custom-emoji" src="${e.emoji}">` : "twemoji" === this.options.style && (o = xe.parse(e.emoji, Ie)),
            ...
            function Le(e, o) {
                return function(e) {
                    ...
                    var i = []
                      ...
                      , r = void 0;
                    try {
                        for (var t, s = e[Symbol.iterator](); !(n = (t = s.next()).done) && (i.push(t.value),
                        !o || i.length !== o); n = !0)
                            ;
                    } catch (e) {
                        a = !0,
            ...
            try {
                ...
                "undefined" != typeof performance && (Ne = performance)
            } catch (r) {}
            var Be = (Te.navigator || {}).userAgent
              ...
              , Re = Ne
              , Ve = (De.document,
            !!Fe.documentElement && !!Fe.head && "function" == typeof Fe.addEventListener && "function" == typeof Fe.createElement)
              , He = (~qe.indexOf("MSIE") || qe.indexOf("Trident/"),
            "group")
            ...
            var Je = De || {};
            Je.___FONT_AWESOME___ || (Je.___FONT_AWESOME___ = {}),
            Je.___FONT_AWESOME___.styles || (Je.___FONT_AWESOME___.styles = {}),
            Je.___FONT_AWESOME___.hooks || (Je.___FONT_AWESOME___.hooks = {}),
            Je.___FONT_AWESOME___.shims || (Je.___FONT_AWESOME___.shims = []);
            ...
            void 0 !== i.g && void 0 !== i.g.process && i.g.process.emit,
            ...
            function ao(e) {
                ...
                var b = Me({}, p, {
                  ...
                  , w = n.found && i.found ? function(e) {
                    var o, i = e.children, n = e.attributes, a = e.main, r = e.mask, t = e.maskId, s = e.transform, m = a.width, c = a.icon, d = r.width, g = r.icon, u = oo({
                        transform: s,
                        containerWidth: d,
                        iconWidth: m
                    }), l = {
                        ...
                        children: [f]
                    }, h = "mask-".concat(t || Ye()), j = "clip-".concat(t || Ye()), p = {
                        tag: "mask",
                        attributes: Me({}, io, {
                            id: h,
            ...
            var ro = (Ue.measurePerformance && Re && Re.mark && Re.measure,
            function(e, o, i, n) {
            ...
            function to(e, o) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}
                  ...
                  , r = Object.keys(o).reduce((function(e, i) {
                    var n = o[i];
                    return n.icon ? e[n.iconName] = n.icon : e[i] = n,
                    e
                }
                ), {});
                "function" != typeof Ge.hooks.addPack || a ? Ge.styles[e] = Me({}, Ge.styles[e] || {}, r) : Ge.hooks.addPack(e, r),
                "fas" === e && to("fa", o)
            }
            var so = Ge.styles
              , mo = Ge.shims
            ...
            function bo(e) {
                var o = e.prefix
                  ...
                  , n = e.iconName;
                if (n)
                    return go(ko.definitions, i, n) || go(Ge.styles, i, n)
            }
            Me({}, vo, {
                cx: "256",
                cy: "364",
            ...
            var wo, ko = new (function() {
                ...
                return (o = [{
                    key: "add",
                    value: function() {
                        for (var e = this, o = arguments.length, i = new Array(o), n = 0; n < o; n++)
                            i[n] = arguments[n];
                        var a = i.reduce(this._pullDefinitions, {});
                        Object.keys(a).forEach((function(o) {
                            e.definitions[o] = Me({}, e.definitions[o] || {}, a[o]),
                            to(o, a[o]),
                            co()
                        }
                        ))
                ...
                if (e) {
                    ...
                    return po(Me({
                        ...
                        return jo(),
                        Ue.autoA11y && (g ? h["aria-labelledby"] = "".concat(Ue.replacementClass, "-title-").concat(l || Ye()) : (h["aria-hidden"] = "true",
                        h.focusable = "false")),
                        ao({
                            icons: {
                                main: ho(k),
            ...
            class Ro {
                ...
                render() {
                    ...
                    return this.emoji.custom ? e = this.lazy ? No : `<img class="emoji-picker__custom-emoji" src="${this.emoji.emoji}">` : "twemoji" === this.options.style && (e = this.lazy ? No : xe.parse(this.emoji.emoji)),
            ...
            class Vo {
                constructor(e, o, i, n, a=!0) {
                    ...
                    this.options = n,
                    this.lazy = a,
                    this.emojis = e.filter((e=>!e.version || parseFloat(e.version) <= parseFloat(n.emojiVersion)))
                }
                render() {
                    const e = Ce("div", "emoji-picker__container");
                    return this.emojis.forEach((o=>e.appendChild(new Ro(o,this.showVariants,!0,this.events,this.options,this.lazy).render()))),
                    e
                }
            }
            var Ho = function(e, o) {
                        ...
                        var d = function() {
                            ...
                            function n() {
                                for (var i = 0, n = e[i], a = 1; a < o; ) {
                                    var r = a + 1;
                                    i = a,
                                    r < o && e[r].score < e[a].score && (i = r),
                                    e[i - 1 >> 1] = e[i],
                                    a = 1 + (i << 1)
                                }
                                for (var t = i - 1 >> 1; i > 0 && n.score < e[t].score; t = (i = t) - 1 >> 1)
                                    e[i] = e[t];
                                e[i] = n
                            }
                            return i.add = function(i) {
                                var n = o;
                                e[o++] = i;
                                for (var a = n - 1 >> 1; n > 0 && i.score < e[a].score; a = (n = a) - 1 >> 1)
                                    e[n] = e[a];
                                e[n] = i
                            }
                            ,
                        ...
                        return function u(l) {
                            var v = {
                                single: function(e, o, i) {
                                    ...
                                    ((i && void 0 !== i.allowTypo ? i.allowTypo : !l || void 0 === l.allowTypo || l.allowTypo) ? v.algorithm : v.algorithmNoTypo)(e, o, e[0])) : null) : null
                                },
                                go: function(e, o, i) {
                                    if (!e)
                                        return n;
                                    ...
                                    if (i && i.keys)
                                        for (var h = i.scoreFn || s, j = i.keys, p = j.length, b = y - 1; b >= 0; --b) {
                                            for (var w = o[b], k = new Array(p), x = p - 1; x >= 0; --x)
                                                (S = m(w, C = j[x])) ? (c(S) || (S = v.getPrepared(S)),
                                                k[x] = d(e, S, a)) : k[x] = null;
                                            k.obj = w;
                                            var E = h(k);
                                            null !== E && (E < r || (k.score = E,
                                            u < t ? (g.add(k),
                                            ++u) : (++f,
                                            E > g.peek().score && g.replaceTop(k))))
                                        }
                                    else if (i && i.key) {
                                        var C = i.key;
                                        for (b = y - 1; b >= 0; --b)
                                            (S = m(w = o[b], C)) && (c(S) || (S = v.getPrepared(S)),
                                            null !== (O = d(e, S, a)) && (O.score < r || (O = {
                                                target: O.target,
                                            ...
                                            u < t ? (g.add(O),
                                            ++u) : (++f,
                                            O.score > g.peek().score && g.replaceTop(O)))))
                                    } else
                                        for (b = y - 1; b >= 0; --b) {
                                            var S, O;
                                            (S = o[b]) && (c(S) || (S = v.getPrepared(S)),
                                            null !== (O = d(e, S, a)) && (O.score < r || (u < t ? (g.add(O),
                                            ++u) : (++f,
                                            O.score > g.peek().score && g.replaceTop(O)))))
                                        }
                                    if (0 === u)
                                        ...
                                        function k() {
                                            ...
                                            if (a && a.keys)
                                                for (var l = a.scoreFn || s, x = a.keys, E = x.length; y >= 0; --y) {
                                                    for (var C = i[y], S = new Array(E), O = E - 1; O >= 0; --O)
                                                        (z = m(C, A = x[O])) ? (c(z) || (z = v.getPrepared(z)),
                                                        S[O] = p(o, z, u)) : S[O] = null;
                                                    S.obj = C;
                                                    var I = l(S);
                                                    if (null !== I && !(I < h) && (S.score = I,
                                                    b < j ? (f.add(S),
                                                    ++b) : (++w,
                                                    I > f.peek().score && f.replaceTop(S)),
                                                    y % 1e3 == 0 && Date.now() - d >= 10))
                                                        return void (e ? setImmediate(k) : setTimeout(k))
                                                }
                                            else if (a && a.key) {
                                                for (var A = a.key; y >= 0; --y)
                                                    if ((z = m(C = i[y], A)) && (c(z) || (z = v.getPrepared(z)),
                                                    null !== (M = p(o, z, u)) && !(M.score < h) && (M = {
                                                        target: M.target,
                                                        _targetLowerCodes: null,
                                                        _nextBeginningIndexes: null,
                                                        score: M.score,
                                                    ...
                                                    b < j ? (f.add(M),
                                                    ++b) : (++w,
                                                    M.score > f.peek().score && f.replaceTop(M)),
                                                    y % 1e3 == 0 && Date.now() - d >= 10)))
                                                        return void (e ? setImmediate(k) : setTimeout(k))
                                            } else
                                                for (; y >= 0; --y) {
                                                    var z, M;
                                                    if ((z = i[y]) && (c(z) || (z = v.getPrepared(z)),
                                                    null !== (M = p(o, z, u)) && !(M.score < h) && (b < j ? (f.add(M),
                                                    ++b) : (++w,
                                                    M.score > f.peek().score && f.replaceTop(M)),
                                                    y % 1e3 == 0 && Date.now() - d >= 10)))
                                                        return void (e ? setImmediate(k) : setTimeout(k))
                                            ...
                                            if (0 === b)
                                                return t(n);
                                            for (var L = new Array(b), P = b - 1; P >= 0; --P)
                                                L[P] = f.poll();
                                            L.total = b + w,
                                            t(L)
                                        }
                                ...
                                algorithmNoTypo: function(e, o, i) {
                                    ...
                                    if (g)
                                        ...
                                        f = a,
                                        y = d;
                                    for (var h = 0, j = -1, p = 0; p < t; ++p)
                                        j !== (c = f[p]) - 1 && (h -= c),
                                        j = c;
                                    for (g || (h *= 1e3),
                                    h -= s - t,
                                    o.score = h,
                                    o.indexes = new Array(y),
                                    p = y - 1; p >= 0; --p)
                                        o.indexes[p] = f[p];
                                    return o
                                },
                                prepareLowerCodes: function(e) {
                                    for (var o = e.length, i = [], n = e.toLowerCase(), a = 0; a < o; ++a)
                                        i[a] = n.charCodeAt(a);
                                    return i
                                },
                                ...
                                prepareNextBeginningIndexes: function(e) {
                                    for (var o = e.length, i = v.prepareBeginningIndexes(e), n = [], a = i[0], r = 0, t = 0; t < o; ++t)
                                        a > t ? n[t] = a : (a = i[++r],
                                        n[t] = void 0 === a ? o : a);
                                    return n
                                },
            ...
            class Wo {
                ...
                render() {
                    ...
                    this.iconUrl ? o.appendChild(Do(this.iconUrl)) : o.innerHTML = zo,
                    e.appendChild(o);
                    const i = Ce("h2");
                    return i.innerHTML = this.message,
                    e.appendChild(i),
                    e
                }
            }
            class Ko {
                constructor(e, o, i, n, a) {
                    ...
                    this.emojiData = n.filter((e=>e.version && parseFloat(e.version) <= parseFloat(i.emojiVersion) && void 0 !== e.category && a.indexOf(e.category) >= 0)),
                    this.options.custom) {
                ...
                render() {
                    return this.searchContainer = Ce("div", "emoji-picker__search-container"),
                    this.searchField = Ce("input", "emoji-picker__search " + this.options.inputClass),
                    this.searchField.placeholder = this.i18n.search,
                    this.searchContainer.appendChild(this.searchField),
                    this.searchIcon = Ce("span", "emoji-picker__search-icon"),
                    this.options.icons && this.options.icons.search ? this.searchIcon.appendChild(Do(this.options.icons.search)) : this.searchIcon.innerHTML = _o,
                ...
                onClearSearch(e) {
                    ...
                    this.options.icons && this.options.icons.search ? (Se(this.searchIcon),
                    this.searchIcon.appendChild(Do(this.options.icons.search))) : this.searchIcon.innerHTML = _o,
                ...
                onKeyUp(e) {
                    if ("Tab" !== e.key && "Shift" !== e.key)
                        if (this.searchField.value) {
                            this.options.icons && this.options.icons.clearSearch ? (Se(this.searchIcon),
                            this.searchIcon.appendChild(Do(this.options.icons.clearSearch))) : this.searchIcon.innerHTML = Bo,
                            ...
                            e.length ? (this.resultsContainer = new Vo(e,!0,this.events,this.options,!1).render(),
                            this.resultsContainer && (this.resultsContainer.querySelector("." + Oe).tabIndex = 0,
                            this.focusedEmojiIndex = 0,
                            this.resultsContainer.addEventListener("keydown", (e=>this.handleResultsKeydown(e))),
                            this.events.emit("showSearchResults", this.resultsContainer))) : this.events.emit("showSearchResults", new Wo(this.i18n.notFound,this.options.icons && this.options.icons.notFound).render())
                        } else
                            this.options.icons && this.options.icons.search ? (Se(this.searchIcon),
                            this.searchIcon.appendChild(Do(this.options.icons.search))) : this.searchIcon.innerHTML = _o,
                            this.searchIcon.style.cursor = "default",
            ...
            class Uo {
                ...
                render() {
                    ...
                    this.popup.appendChild(new Ro(this.emoji,!1,!1,this.events,this.options,!1).render()),
                    (this.emoji.variations || []).forEach(((e,o)=>this.popup.appendChild(new Ro({
                    ...
                    this.popup.addEventListener("keydown", (e=>{
                        "ArrowRight" === e.key ? this.setFocusedEmoji(Math.min(this.focusedEmojiIndex + 1, this.popup.querySelectorAll("." + Oe).length - 1)) : "ArrowLeft" === e.key ? this.setFocusedEmoji(Math.max(this.focusedEmojiIndex - 1, 0)) : "Escape" === e.key && (e.stopPropagation(),
            ...
            class Xo {
                ...
                render() {
                    ...
                    return this.options.custom && (o = [...o, "custom"]),
                    o.forEach((o=>{
                        const i = Ce("button", "emoji-picker__category-button");
                        this.options.icons && this.options.icons.categories && this.options.icons.categories[o] ? i.appendChild(Do(this.options.icons.categories[o])) : i.innerHTML = Go[o],
                        i.tabIndex = -1,
                        i.title = this.i18n.categories[o],
                        e.appendChild(i),
                        this.buttons.push(i),
                ...
                setActiveButton(e, o=!0) {
                    ...
                    i.tabIndex = -1,
                    this.activeButton = e,
                    i = this.buttons[this.activeButton],
            ...
            Ee.emoji.forEach((e=>{
                ...
                o || (o = $o[Ee.categories[e.category]] = []),
                o.push(e)
            }
            ));
            class Yo {
                constructor(e, o, i) {
                    ...
                    this.addCategory = (e,o)=>{
                        ...
                        i.innerHTML = this.i18n.categories[e] || Jo.categories[e],
                        this.emojis.appendChild(i),
                        this.headers.push(i),
                        this.emojis.appendChild(new Vo(o,!0,this.events,this.options,"recents" !== e).render())
                    }
                    ,
                    ...
                    ,
                    this.emojisPerRow = i.emojisPerRow || 8,
                    this.categories = i.categories || Ee.categories,
                    i.showRecents && (this.categories = ["recents", ...this.categories]),
                    i.custom && (this.categories = [...this.categories, "custom"])
                }
                updateRecents() {
                ...
                render() {
                    return this.container = Ce("div", "emoji-picker__emoji-area"),
                    this.options.showCategoryButtons && (this.categoryButtons = new Xo(this.options,this.events,this.i18n),
                    this.container.appendChild(this.categoryButtons.render())),
                    this.emojis = Ce("div", "emoji-picker__emojis"),
                    this.options.showRecents && ($o.recents = Fo()),
                    this.options.custom && ($o.custom = this.options.custom.map((e=>({
                        ...e,
                        custom: !0
                    })))),
                    this.categories.forEach((e=>this.addCategory(e, $o[e]))),
                    ...
                    this.container.querySelectorAll("." + Oe)[0].tabIndex = 0,
                    this.container
                }
                reset() {
            ...
            class ei {
                ...
                buildPicker() {
                    if (this.pickerEl = Ce("div", "emoji-picker"),
                    ...
                    this.focusTrap = function(e, o) {
                        var i = document
                          ...
                          , t = {
                            ...
                            deactivate: s,
                            pause: function() {
                                !r.paused && r.active && (r.paused = !0,
                                c())
                            },
                            unpause: function() {
                                r.paused && r.active && (r.paused = !1,
                                p(),
                                m())
                            }
                        };
                        ...
                        function s(e) {
                            if (r.active) {
                                ...
                                return o && o(),
                                (e && void 0 !== e.returnFocus ? e.returnFocus : a.returnFocusOnDeactivate) && w((function() {
                                    var e;
                        ...
                        function c() {
                            if (r.active)
                                return i.removeEventListener("focusin", l, !0),
                                i.removeEventListener("mousedown", u, !0),
                                i.removeEventListener("touchstart", u, !0),
                                i.removeEventListener("click", y, !0),
                        ...
                        function d(e) {
                            ...
                            if (!o)
                                return null;
                            if ("string" == typeof o && !(n = i.querySelector(o)))
                        ...
                        function g() {
                            var e;
                            if (!(e = null !== d("initialFocus") ? d("initialFocus") : n.contains(i.activeElement) ? i.activeElement : r.firstTabbableNode || d("fallbackFocus")))
                        ...
                        function l(e) {
                            n.contains(e.target) || e.target instanceof Document || (e.stopImmediatePropagation(),
                            k(r.mostRecentlyFocusedNode || g()))
                        }
                        function v(e) {
                            ...
                            (function(e) {
                                ...
                                e.shiftKey || e.target !== r.lastTabbableNode || (e.preventDefault(),
                                k(r.firstTabbableNode))
                            }(e)
                        }
                        function y(e) {
                            a.clickOutsideDeactivates || n.contains(e.target) || a.allowOutsideClick && a.allowOutsideClick(e) || (e.preventDefault(),
                            e.stopImmediatePropagation())
                        }
                        function p() {
                            var e = h(n);
                            r.firstTabbableNode = e[0] || g(),
                            r.lastTabbableNode = e[e.length - 1] || g()
                        }
                        function k(e) {
                            e !== i.activeElement && (e && e.focus ? (e.focus(),
                    ...
                    this.pickerContent = Ce("div", "emoji-picker__content"),
                    ...
                    this.emojiArea = new Yo(this.events,this.i18n,this.options),
                    this.pickerContent.appendChild(this.emojiArea.render()),
                    this.events.on("showSearchResults", (e=>{
                        Se(this.pickerContent),
                        e.classList.add("search-results"),
                        this.pickerContent.appendChild(e)
                    }
                    )),
                    this.events.on("hideSearchResults", (()=>{
                        this.pickerContent.firstChild !== this.emojiArea.container && (Se(this.pickerContent),
                        this.pickerContent.appendChild(this.emojiArea.container)),
                        this.emojiArea.reset()
                    }
                    )),
                    this.options.showPreview && this.pickerEl.appendChild(new Ae(this.events,this.options).render()),
                    this.events.on("emoji", (({emoji: e, showVariants: o})=>{
                        e.variations && o && this.options.showVariants ? this.showVariantPopup(e) : (setTimeout((()=>this.emojiArea.updateRecents())),
                        e.custom ? this.publicEvents.emit("emoji", {
                            url: e.emoji,
                            name: e.name,
                            custom: !0
                    ...
                    this.wrapper = Ce("div", "emoji-picker__wrapper"),
                        ...
                        Array.prototype.filter.call(e, (e=>e.intersectionRatio > 0)).map((e=>e.target)).forEach((e=>{
                            if (!e.dataset.loaded)
                                if (e.dataset.custom) {
                                    ...
                                    o.src = e.dataset.emoji,
                                    e.innerText = "",
                                    e.appendChild(o),
                                    e.dataset.loaded = !0,
                                    e.style.opacity = 1
                                } else
                                    "twemoji" === this.options.style && (e.innerHTML = xe.parse(e.dataset.emoji, Zo),
                                    e.dataset.loaded = !0,
                                    e.style.opacity = "1")
                        }
                        ))
                ...
                hidePicker() {
                    ...
                    setTimeout((()=>{
                        ...
                        e && (e.value = ""),
                        this.pickerEl.querySelector(".emoji-picker__variant-overlay") && this.events.emit("hideVariantPopup"),
                ...
                showPicker(e) {
                    if (this.hideInProgress)
                        ...
                        window.matchMedia("screen and (max-width: 450px)").matches) {
                            ...
                            this.overlay = Ce("div", "emoji-picker__overlay"),
                            document.body.appendChild(this.overlay)
                        } else
                            "string" == typeof this.options.position ? this.popper = pe(e, this.wrapper, {
                                placement: this.options.position
                            }) : this.options.position && (this.options.position.top || this.options.position.left) && (this.wrapper.style.position = "fixed",
                            this.options.position.top && (this.wrapper.style.top = this.options.position.top),
                            this.options.position.bottom && (this.wrapper.style.bottom = this.options.position.bottom),
                            this.options.position.left && (this.wrapper.style.left = this.options.position.left),
                            this.options.position.right && (this.wrapper.style.right = this.options.position.right));
                        this.focusTrap.activate(),
                        setTimeout((()=>{
                            document.addEventListener("click", this.onDocumentClick),
                            document.addEventListener("keydown", this.onDocumentKeydown),
                            this.pickerEl.querySelector(this.options.showSearch && this.options.autoFocusSearch ? ".emoji-picker__search" : `.${Oe}[tabindex="0"]`).focus()
                        }
                        )),
                        this.emojiArea.reset()
                    }
            ...
            (0,
            a.Z)(document.querySelectorAll('[data-autosize="true"]')),
            document.querySelectorAll('[data-theme-toggle="tab"]').forEach((e=>{
                e.addEventListener("click", (o=>{
                    o.preventDefault(),
                    new n.OK(document.querySelector(e.hash)).show()
                }
                ))
            }
            )),
            ...
            window.onload = function() {
                var e;
                e = ".chat-body-inner",
                (e = document.querySelectorAll(e)).length && e[e.length - 1].scrollIntoView(!1, {
                    block: "end"
                })
            }
            ,
        ...
        82: ()=>{
            [].forEach.call(document.querySelectorAll("[data-horizontal-scroll]"), (function(e) {
                ...
                e.addEventListener ? (e.addEventListener("mousewheel", o, !1),
                e.addEventListener("DOMMouseScroll", o, !1)) : e.attachEvent("onmousewheel", o)
            }
            ))
        }
        ,
        ...
        ,
        94: ()=>{
            var e = document.querySelectorAll("link[class=css-lt]")
            ...
            [...i].forEach((i=>{
                i.addEventListener("click", (i=>{
                    [...n].forEach((e=>{
                        e.classList.contains("d-none") && (r = e.getAttribute("data-theme-mode")),
                        e.classList.toggle("d-none")
                    }
                    )),
                    r && (function(e) {
                        var newE = (a() == 'light') ? 'dark' : 'light';
                        localStorage.setItem("color-scheme", newE)
                    }(r),
                    function(i) {
                        [...e].forEach((e=>{
                            e.media = "light" === a() ? "all" : "not all"
                            }
                        )),
                        [...o].forEach((e=>{
                            e.media = "dark" === a() ? "all" : "not all"
                            }
                        ))
                    }(r))
                }
    ...
    n.O = (o,i,a,r)=>{
        if (!i) {
            ...
            for (d = 0; d < e.length; d++) {
                for (var [i,a,r] = e[d], s = !0, m = 0; m < i.length; m++)
                    (!1 & r || t >= r) && Object.keys(n.O).every((e=>n.O[e](i[m]))) ? i.splice(m--, 1) : (s = !1,
                    r < t && (t = r));
                if (s) {
                    e.splice(d--, 1);
                    var c = a();
    ...
    n.d = (e,o)=>{
        for (var i in o)
            n.o(o, i) && !n.o(e, i) && Object.defineProperty(e, i, {
                enumerable: !0,
                get: o[i]
            })
    }
